...
func (c Context) KVStore(key StoreKey) KVStore {
	return c.multiStore().GetKVStoreWithGas(c.GasMeter(), cachedDefaultGasConfig, key)
}

// TransientStore fetches a TransientStore from the MultiStore.
func (c Context) TransientStore(key StoreKey) KVStore {
	return c.multiStore().GetKVStoreWithGas(c.GasMeter(), cachedTransientGasConfig, NewTransientStoreKey(key))
}
